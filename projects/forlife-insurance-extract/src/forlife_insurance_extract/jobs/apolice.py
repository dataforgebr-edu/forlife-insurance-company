...
from forlife_insurance_extract.services.apolice import stream_apolices_extract
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Job de extração de apólices para NDJSON."
    )
...
def main() -> None:
    ...
    print(
        f"Job concluído: rows_written={result.rows_written}, output_path={result.output_path}"
    )
